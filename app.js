...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('SushiWasabi.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('SushiWasabi.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('SushiWasabi.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('SushiWasabi.xml', result, function(err) {
